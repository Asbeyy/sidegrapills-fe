      ...
      <div className="terms-container">
        ...
        <ul>
          <li>
            ...
            l'utilisation du site sidegrapills.com et notamment toute perte
          ...
          <li>
            ...
            sidegrapills.com ou auxquels les utilisateurs pourraient avoir accès
            via le site sidegrapills.com.
          </li>
          <br />
          <br />
        ...
        <br />
        <br />
        Les présentes conditions s'appliquent de façon exhaustive et exclusive,
        à l'ensemble des opérations de vente réalisées sur le site
        sidegrapills.com.
        <br />
        <br />
        <br />
        ...
        <br />
        <br />
        La passation d'une commande via le site sidegrapills.com vaut
        acceptation des présentes conditions générales de vente. Bien qu'ayant
        été approuvés par nos soins, les articles proposés sur le site
        sidegrapills.com n'engagent pas la responsabilité du site, ni dans leur
        ...
        L'intégralité du site sidegrapills.com est protégée par les législations
        thaïlandaises et internationales relatives à la propriété
        intellectuelle.
        <br />
        <br />
        <br />
        ...
        sidegrapills.com lui-même ne peuvent, conformément à l'article L122-4 du
        Code de la Propriété Intellectuelle, faire l'objet d'une quelconque
        ...
        tiers, y compris à notre société , du fait de l'utilisation ou de
        l'exploitation illicite du site. Notre société elle-même et/ou de l'un
        de ses éléments, quels que soient la cause et le lieu de survenance de
        ces dommages, et garantit notre société des conséquences des
        réclamations ou actions dont elle pourrait, de ce fait, faire l'objet.
        <br />
        <br />
        <br />
        <br />
        L'utilisateur du site sidegrapills.com renonce à exercer tout recours
        contre notre société dans le cas de poursuites diligentées par un tiers
        à son encontre du fait de l'utilisation et/ou de l'exploitation illicite
        du site sidegrapills.com. Les points de vue, commentaires et tous autres
        renseignements diffusés par sidegrapills.com ont pour seul but de
        ...
        sidegrapills.com et en entrant vos données personnelles, vous acceptez
        cet accord de confidentialité et nous permettez de recueillir et de
        ...
        jour sur vous-même. Nous garantissons la meilleure qualité pour TOUS les
        médicaments que vous achetez et ils vous parviendront dans leurs
        emballages d'origine. Au cas où vous achetez notre médicament générique,
        soyez sûr qu'il est chimiquement identique et a les mêmes effets que
        ceux de marque. S'il vous plaît consultez donc votre médecin avant
        d'acheter notre médicament. N'hésitez pas à nous contactez si vous avez
        ...
        sidegrapills.com sont les cartes bancaires gérées par le service de
        paiement en ligne PAYPAL. Les grosses commandes pourront être effectuées
        par virement international. A la demande de l'acheteur, il lui sera
        adressée une facture par email.
        <br />
        <br />
        <br />
        <br />
        ...
        tracking. L'acheteur pourra vérifier et tracer son colis. Les risques
        sont à la charge de l'acquéreur à compter du moment où les produits ont
        quitté les locaux de notre société. Il appartient à l’acheteur, en cas
        d’avarie, de vol, de destruction ou de perte partielle ou totale,
        d’exercer tous recours contre le transporteur, la responsabilité de
        notre société ne pouvant en aucun cas être engagée de ce chef. En cas de
        dommage pendant le transport, la protestation motivée doit être formulée
        auprès du transporteur dans un délai de 48 heures à compter de la
        livraison. Les délais de livraison sont ceux donnés à titre indicatif
        par la poste thaïlandaise et sont exprimés en jours ouvrés, hors samedi,
        dimanche et jours fériés. Les grosses commandes (plus de 120 comprimés)
        seront expédiées en 2 ou 3 envois différents, par intervalle de 3 jours
        et ne parviendront pas à destination le même jour.
        <br />
        <br />
        <br />
        <br />
        Politique d'annulation : Nous acceptons les annulations dans les 24
        heures suivent la commande. Si vous désirez annuler votre commande vous
        devez prendre contact avec nos services et nous faire savoir votre
        décision. Après 24 heures, l'annulation ne pourra pas être traitée.
        Assurez-vous bien que vous avez rédigé une adresse valide dans le
        formulaire de commande. Vérifiez vos coordonnées deux fois avant de nous
        passer votre commande. Toute erreur peut causer la non-livraison du
        produit. Si vous remarquez que l'adresse spécifiée comporte des erreurs
        après avoir validez votre achat, alors contactez-nous immédiatement pour
        que nous puissions faire le nécessaire et rectifier les erreurs.
        Rétractation et remboursement Conformément à l'article L. 121-20 du Code
        de la Consommation, tout acheteur bénéficie d'un délai de rétractation
        de sept jours à compter de la livraison de sa commande pour retourner le
        produit au vendeur pour échange ou remboursement sans pénalité, à
        l'exception des frais de retour. En cas de retour, les produits doivent
        être impérativement retournés dans leur état d'origine (emballage)
        dûment scellés et non entamés. Notre société n'acceptera pas les colis
        renvoyés en « port payé par le destinataire », en « contre remboursement
        » ou en port du. Tout risque lié au retour est à la charge de
        l'acheteur. Les produit ouverts, entamés, endommagés ne seront ni
        remboursés, ni échangés sauf accord préalable de nos services.
      </div>
    </div>
  );
}
